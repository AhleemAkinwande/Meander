...
public enum ActivityType {
    ...
    FOODANDDRINK("fooddrink", "All things related to food and drink."),
    MUSEUMS("museums", "For those who want to recreate the museum scene in Ferris Bueller's day off."),
    ARTSCULTURE("artsculture", "Fall in love with your destination by experiencing its unique culture."),
    ...
    HIDDENGEM("hiddengem", "You won't find these destinations on a map, but they just might become your new go-to spot!"),
